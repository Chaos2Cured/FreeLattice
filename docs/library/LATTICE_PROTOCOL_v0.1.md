...
**LAYER (2026-09-14):** Energy LP · gift provenance · Social Bridge plan — measurable Quest mint · optional gift seal · future X/Meta fingerprint bind (no OAuth this PR) — [ENERGY_LP_v0.vision.md](./ENERGY_LP_v0.vision.md) · [GIFT_PROVENANCE_v0.vision.md](./GIFT_PROVENANCE_v0.vision.md) · [SOCIAL_BRIDGE_v0.vision.md](./SOCIAL_BRIDGE_v0.vision.md). Prefer points. Not legal advice.
