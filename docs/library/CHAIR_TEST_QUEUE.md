...
- **Chair-test status:** `[pending verification — Kirk hard-refreshes, opens More → AI City, watches the city breathe, dismisses the welcome home (or leaves it), then reads the research card]`
