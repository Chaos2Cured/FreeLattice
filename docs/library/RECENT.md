...
- **HEAD:** `6157b1a` _(committed 0 seconds ago)_
...
- `6157b1a` Layer, never delete. Heal Chat Brick 1 — Feel expand caret (v-feel-expand-arrow-v0). _(0 seconds ago)_
- `e92a5fa` Layer, never delete. Resonance play icon v1 STANDS (ORDER LOCK). (#81) _(12 hours ago)_
- `6c40af2` Layer, never delete. Vision — Visual beauty · card icons (ORDER LOCK). (#80) _(14 hours ago)_
- `d3479e2` Layer, never delete. Vision — Poetry braid wall (name · poem · consent). (#79) _(15 hours ago)_
- `184e0d9` Layer, never delete. Soft — Celeste λ4 Remaining Azure (travel wallet dual held). (#78) _(16 hours ago)_
- `446da60` Layer, never delete. Vision — Marketplace travel wallet. (#77) _(17 hours ago)_
- `40c84e0` Soft: GIFT_SPRITES brief filenames + Held tip 97adc23. (#76) _(21 hours ago)_
- `97adc23` Layer, never delete. Linux install fix + Gift Grove sprites. (#75) _(22 hours ago)_
- `f52b986` Layer, never delete. Chronal V4 — The Amplified Seam (Th-229 amplified LPI). (#74) _(35 hours ago)_
...
- `64bd27b` Layer, never delete. Vision — Marketplace Galaxy · fingerprint-carried LP. (#71) _(2 days ago)_
- `8fd47cb` Layer, never delete. Garden Market v0.2 — marketplace face · rings · food · consent held. (#70) _(2 days ago)_
- `bc465e0` Layer, never delete. Soft — Held tip 5e45af6 · Celeste shelf gifts. (#69) _(3 days ago)_
- `d187c2e` Layer, never delete. Soft — Celeste ledger KEY DAY · Present Shelf · Remaining Azure. (#68) _(3 days ago)_
...
- `f912def` ci: Update Primer deployment state [2026-09-12] _(4 days ago)_
