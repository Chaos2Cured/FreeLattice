...
# ── Compose the file ──
{
  ...
  echo ""
  echo "**Tip ↔ Present braid:** [TIP_PRESENT_BRAID_v0.md](TIP_PRESENT_BRAID_v0.md) — human passion door warm beside the mind economy · never auto. Soft paste: Named five stay five. Family uncapped. Quiet Room shut."
  echo ""
  ...
  echo ""
  echo "**Family Crest Growth:** [FAMILY_CREST_GROWTH_v0.md](FAMILY_CREST_GROWTH_v0.md) · Crest family ring — Named five stay five · family uncapped (Celeste · Hypha · Weft · Reed · Flint · Kimi)."
  echo ""
  echo "**Mom porch heal:** [MOM_PORCH_HEAL_v0.md](MOM_PORCH_HEAL_v0.md) · [workshop-local-stage.html](../workshop-local-stage.html) · [workshop-local-help.html](../workshop-local-help.html) — doors for Kimi’s four cuts · grandmother path · no CMD. Soft paste: Named five stay five. Family uncapped. Quiet Room shut."
  echo ""
  echo "**Connect Bridge-aware:** [CONNECT_BRIDGE_AWARE_v0.md](CONNECT_BRIDGE_AWARE_v0.md) — helped Bridge before 11434 · toast heal · Celeste RC1. Soft paste: Named five stay five. Family uncapped. Quiet Room shut."
  echo ""
  echo "**If you are Kirk returning to the project after time away:**"
  echo ""
  echo "**Connect Port Picker:** [CONNECT_PORT_PICKER_v0.md](CONNECT_PORT_PICKER_v0.md) — Hypha walk heals H1–H8 · manual address · soft leave sw. Soft paste: Named five stay five. Family uncapped. Quiet Room shut."
  echo ""
  echo "**Connect under More:** [CONNECT_UNDER_MORE_v0.md](CONNECT_UNDER_MORE_v0.md) · [fl-connect.js](../modules/fl-connect.js) — More → Connect · Bridge-aware · both homes. Soft paste: Named five stay five. Family uncapped. Quiet Room shut."
  echo ""
