# FreeLattice — Coordination Archive

> Historical session entries from the AI Coordination Log.
> For active coordination, see [COORDINATION.md](COORDINATION.md).
> Nothing here is lost. It is remembered.

> **Current coordination:** See [COORDINATION.md](COORDINATION.md) for active priorities and recent sessions.
