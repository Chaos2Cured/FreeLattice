...
- **Water-to-grow**: lifecycle `seed(0) → sprout(15) → juvenile(50) → adult(120) → evolved(250)` (same thresholds as `fractal-garden.js`), persisted to `fl_literal_garden_v1` + legacy seed from `fl_luminos_evolution`.
